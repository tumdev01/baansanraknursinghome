...
class ThemePluginFilesFinalize {
	...
	public function maybe_finalize_tp_migration( $intent ) {
		...
		if (
			empty( array_intersect(
				[ 'theme_files', 'plugin_files', 'muplugin_files', 'other_files' ],
	...
	public function cleanup_transfer_migration() {
		...
		if (
			! empty( array_intersect(
				[ 'theme_files', 'plugin_files', 'muplugin_files', 'other_files', 'core_files' ],
				$stages
			) )
		) {
