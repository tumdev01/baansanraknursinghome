<?php
/**
 * Database Backup: SecuPress_Backup_Db_Local class
 *
 * @package SecuPress
 * @since 1.0
 */
...
/**
 * Class extending the `SecuPress_Backup_Db` class, allowing to create local backups.
 *
 * @since 1.0
 * @see SecuPress_Backup_Db
 */
class SecuPress_Backup_Db_Local extends SecuPress_Backup_Db {
